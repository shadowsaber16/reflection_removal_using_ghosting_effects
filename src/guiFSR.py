...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.blur_h = 0  # Updated brightness value
        self.brightness = 0  # Updated blur value
    ...
    def changeBrightness(self, img, value):
        ...
        """
        ret = fastReflectionSuppression(img, value/1000)
        ret *= 255
        return ret.astype(uint8).clip(0, 255)
    ...
    def update(self):
        ...
        """
        img = self.changeBrightness(self.image, self.blur_h)
        img = self.changeBlur(img, self.brightness)
        self.setPhoto(img)
